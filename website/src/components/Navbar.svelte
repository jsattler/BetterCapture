    ...
    <div class="grid grid-cols-3 items-center">
      ...
      <a href="{base}">
        <div class="flex items-center gap-2">
          ...
          <span class="text-xl font-semibold text-gray-900">BetterCapture</span>
        </div>
      </a>
      ...
      <div class="flex items-center justify-center gap-6">
        ...
        <a 
          ...
          class="text-gray-600 hover:text-gray-900 transition-colors text-md font-semibold"
        >
          Roadmap
        </a>
      </div>
      ...
      <div class="flex justify-end">
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          class="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors"
        >
